...
using (var client = config.GetWebCloudClient())
{
	client.UpdateSiteConfig(sub, ws, site, new SiteConfig { LinuxFxVersion = "node|10.1", AppCommandLine = "/bin/bash -c /home/site/wwwroot/startup.sh", RemoteDebuggingEnabled = true });
	client.UpdateSiteSourceControl(sub, ws, site, new SiteSourceControl { IsManualIntegration=true, RepoUrl = "https://github.com/patricklee2/nodejs-docs-hello-world.git", Branch="master"});
